...
$formats = new Exchange\Formats($numberFormatFactory);
...
Assert::same('100 EUR', $formats->getFormat('EUR')->format('100', null, 'EUR'));
Assert::same($formats->getFormat('EUR'), $formats->getFormat('EUR'));
Assert::same('100,00 $', $formats->getFormat('USD')->format('100', null, 'USD'));
Assert::same('100,000 CZK', $formats->getFormat('CZK')->format('100', null, 'CZK'));
Assert::same('100 CZK', $formats->getFormat('CZK')->format('100', 0, 'CZK'));
